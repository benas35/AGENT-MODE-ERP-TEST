...
-- Insert seed data for work zones
INSERT INTO work_zones (org_id, name, code, description, capacity, color) 
VALUES 
  (get_user_org_id(), 'General Repair', 'GEN', 'General automotive repair bay', 2, '#10B981'),
  (get_user_org_id(), 'Quick Service', 'QS', 'Oil changes and quick maintenance', 4, '#F59E0B'),
  (get_user_org_id(), 'Diagnostics', 'DIAG', 'Computer diagnostics and electrical', 1, '#EF4444'),
  (get_user_org_id(), 'Bodywork', 'BODY', 'Body repair and painting', 1, '#8B5CF6')
