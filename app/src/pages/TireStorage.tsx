...
export default function TireStorage() {
  ...
  const filteredTires = tireSets.filter(tire => {
    ...
    const matchesSeason = !selectedSeason || selectedSeason === 'ALL' || tire.season === selectedSeason;
    const matchesRack = !selectedRack || selectedRack === 'ALL' || tire.rack_location.startsWith(selectedRack);
